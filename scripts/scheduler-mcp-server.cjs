...
const TOOLS = [
  ...
  },
  {
    ...
    description: descriptionFor('project_home_write'),
    inputSchema: {
      type: 'object',
      properties: {
        ...
        html: { type: 'string', description: 'The complete self-contained HTML document (<= 1MB; no <script src>, <link href=http*>, @import, or url(http*)).' },
      },
      required: ['html'],
    },
  },
