...
const promptSessionsCreateEpic = require('./lib/promptSessionsCreateEpic.cjs');
const epicWorktreeMint = require('./lib/epicWorktreeMint.cjs');
...
// header. prd-write-guard and destructive-git-guard stay separate handlers
// (and separate PreToolUse entries) because those two hooks have different
// matchers: Write|Edit|NotebookEdit vs Bash — installDestructiveGitGuard's
...
layoutStore.registerLayoutHandlers();
...
activeIndexMerge.registerActiveIndexMergeHandlers();
promptSessionsCreateEpic.registerPromptSessionsCreateEpicHandlers();
epicWorktreeMint.registerEpicWorktreeMintHandlers();
epicWorktreeMerge.registerEpicWorktreeMergeHandlers();
epicWorktreeProjectConfig.registerEpicWorktreeProjectConfigHandlers();
