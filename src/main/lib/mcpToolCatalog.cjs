...
const MCP_TOOL_CATALOG = [
  ...
  },
  {
    ...
    group: 'scheduler',
    purpose: "Clear any scheduler pause (manual or automatic) via the session-manager app's admin API.",
    whenToUse: 'Use to restart dispatch after scheduler_pause, or to lift an auto-pause you have judged stale.',
    whenNotToUse: 'Do not use to retry a parked needs_review job — that is scheduler_reset_job.',
    exampleArgs: {},
    notes: null,
  },
  {
  ...
  {
    name: 'project_home_write',
    group: 'project-home',
    purpose: "Write this project's Project Home page — ONE self-contained HTML document — to "
      + "session-manager-operations/project-pages/home.html via the session-manager app's admin API. "
    ...
    exampleArgs: { cwd: '/home/bilko/Projects/session-manager', html: '<!DOCTYPE html><html><body><h1>Example</h1></body></html>' },
