...
export function buildCommands(): Command[] {
  const cmds: Command[] = [
    ...
    { id: 'reboot-app', label: 'Reboot app (drain first)', section: 'session', run: () => window.api.app.rebootApp() },
    { id: 'reboot-app-force', label: 'Reboot app NOW (force — kills running jobs)', section: 'session', run: () => window.api.app.rebootApp({ force: true }) },
