...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'src/main/__tests__/scheduler-mutate-reentrancy.test.cjs',
      ...
      'src/main/__tests__/openExternalApp-spawn-error.test.cjs',
      ...
      'src/main/__tests__/health-credentials.test.cjs',
      ...
      'src/main/__tests__/agentOverlayWrite.test.cjs',
